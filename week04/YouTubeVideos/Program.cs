...
class Program
{
    static void Main(string[] args)
    {
        ...
        commentList1.Add(video1Comment1);
        ...
        //Append the comment to the list of comments
        commentList1.Add(video1Comment2);
        ...
        //Append the comment to the list of comments
        commentList1.Add(video1Comment3);
        ...
        //Append the comment to the list of comments
        commentList2.Add(video2Comment1);
        ...
        //Append the comment to the list of comments
        commentList2.Add(video2Comment2);
        ...
        //Append the comment to the list of comments
        commentList2.Add(video2Comment3);
        ...
        //Append the comment to the list of comments
        commentList2.Add(video2Comment4);
        ...
        //Append the comment to the list of comments
        commentList3.Add(video3Comment1);
        ...
        // Create a list of comments
        List<Comment> commentList4 = new List<Comment>();
        ...
        //Append the comment to the list of comments
        commentList4.Add(video4Comment1);
        ...
        //Append the comment to the list of comments
        commentList4.Add(video4Comment2);
        ...
        //Append the comment to the list of comments
        commentList4.Add(video4Comment3);
